...
<frameset rows="100,*" cols="*" scrolling="No" framespacing="0"
	frameborder="no" border="0"> <frame src="assets/admin/inc/head.html"
...
<!-- 引用左边和主体部分 --> <frameset rows="100*" cols="220,*" scrolling="No"
	...
	src="assets/admin/inc/left.html" name="leftmenu" id="mainFrame" title="mainFrame">
<frame src="assets/admin/inc/main.html" name="main" scrolling="yes" noresize="noresize"

...
<link rel="stylesheet" type="text/css" href="assets/admin/css/manhuaDate.1.0.css">
	<script type="text/javascript" src="assets/admin/js/jquery.min.js"></script>
	<script type="text/javascript" src="assets/admin/js/manhuaDate.1.0.js"></script>
	<script type="text/javascript" src="assets/admin/js/jquery-1.7.2.min.js"></script>
	<!-- <script type="text/javascript" src="assets/admin/js/page.js" ></script> -->
...
<body>
					...
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><div class="onsImg onsImgv">
									<img src="assets/admin/img/banimg.png">
								</div></td>
							<td>山下就只</td>
							<td>13312345678</td>
							<td>南京市</td>
							...
							<td><a href="connoisseuradd.html"><img class="operation"
									src="assets/admin/img/update.png"></a> <img class="operation delban"
								src="assets/admin/img/delete.png"></td>
						</tr>
					</table>
	...
	<div class="banDel">
		<div class="delete">
			<div class="close">
				<a><img src="assets/admin/img/shanchu.png" /></a>
			</div>

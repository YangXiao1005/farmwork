			...
			<div class="bacen">
				...
				<div class="bbD">
					&nbsp;&nbsp;&nbsp;&nbsp;输入旧密码：<input type="password" class="input3"
						...
						src="assets/admin/img/ok.png" /><img class="imgb" src="assets/admin/img/no.png" />
				</div>
				<div class="bbD">
				...
				<div class="bbD">
					再次确认密码：<input type="password" class="input3" onblur="checkpwd3()"
						id="pwd3" /> <img class="imga" src="assets/admin/img/ok.png" /><img
						class="imgb" src="assets/admin/img/no.png" />
				</div>
				<div class="bbD">
					<p class="bbDP">
